...
def play():
    ...
    R_img8 = ImageTk.PhotoImage(PIL.Image.open('home.png').resize((20, 20)))
...
def menu():
    ...
    def ranking():
        ...
        R_img0_0 = ImageTk.PhotoImage(PIL.Image.open('primeiro.png').resize((40, 40)))
        R_img0_1 = ImageTk.PhotoImage(PIL.Image.open('segundo.png').resize((40, 40)))
        R_img0_2 = ImageTk.PhotoImage(PIL.Image.open('terceiro.png').resize((40, 40)))
        R_img0_3 = ImageTk.PhotoImage(PIL.Image.open('replay.png').resize((20, 20)))
        ...
        list_ranking = []
        arq = open('ranking.txt').readlines()
    ...
    R_img1 = ImageTk.PhotoImage(PIL.Image.open('papel.png').resize((60, 60)))
    R_img2 = ImageTk.PhotoImage(PIL.Image.open('tesoura.png').resize((60, 60)))
